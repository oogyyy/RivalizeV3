  ...
  return (
    <div className="glass-card rounded-2xl border border-white/10 p-8 shadow-[0_24px_64px_rgba(0,0,0,0.5)]">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            disabled={loading || oauthLoading !== null}
            className="w-4 h-4 rounded border border-white/20 bg-white/5 accent-[#00ff87] cursor-pointer"
          />
          <label htmlFor="remember-me" className="text-sm text-white/60 cursor-pointer select-none">
      ...
      <p className="mt-6 text-center text-sm text-white/40">
        ...
        <Link href="/signup" className="text-[#00ff87] hover:text-[#00ff87]/80 font-medium transition-colors">
          Create one free
        </Link>
      </p>
    </div>
