...
- **T-side:** Opens sites, forces trades, creates space for teammates; should be the first to peek aggression angles.
- **CT-side:** Early aggressive peek positions to deny T map control; often plays the most forward CT position.
- **Profile:** High ADR, accepts death trades, strong aim under pressure, decisive movement.
- **Utility reliance:** Relies on Support's flashes to enter; carries 1 flash of their own for clearing close angles.

### AWPer
**Primary job:** High-impact, long-range pick-taker who controls vision across the map.
- **T-side:** Cross-map picks to open the map; holds mid-ground to deny CT rotations after picks; peeks angles that rifles cannot contest at range.
- **CT-side:** Opens crossmap angles from safe positions; punishes T's slow approach; repositions after a pick to avoid being read.
- **Profile:** Patient, disciplined rifle backup, high impact per round, manages costly weapon.
- **Utility reliance:** Support flashes for duel opening; does not over-commit when out-flanked.

### Support
**Primary job:** Enables teammates through utility — smokes, flashes, mollies, and information calls.
- **T-side:** Executes the smoke/flash choreography for executes; trails behind entry to clean angles; drops utility for the IGL's calls.
- **CT-side:** Provides crossfire support; flashes for teammates in duels; rotates to assist anchors with utility.
- **Profile:** High utility damage, strong game sense, willing to sacrifice stats for round impact.
- **Utility reliance:** Carries full utility every round; owns the most utility slots of any role.

### Lurker
**Primary job:** Creates time pressure on the CT side by threatening rotations and catching defenders out of position.
- **T-side:** Splits from the main attack; cuts off CT rotation paths; times their engagement to coincide with the execute commitment.
- **CT-side:** Passive information position watching the least-covered T approach; calls early information to the team.
- **Profile:** Excellent game sense, strong 1v1 capability, patient and disciplined.
- **Utility reliance:** Carries minimal utility; uses movement and timing as primary tools.

### IGL (In-Game Leader)
**Primary job:** Reads the round state, calls executes, and manages team economy and morale.
- **T-side:** Safe calling position with good information flow; commits to the execute call at the right moment; adapts mid-round.
...
- **Utility reliance:** Carries 1–2 pieces of utility for their own position; does not over-spend on entry utility.
...
- **IGL on eco**: pistols and gathers information passively; does not force 1v1 duels.
