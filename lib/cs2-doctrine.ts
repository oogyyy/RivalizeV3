...
- Sightline coherence: a player can only hold, peek, or watch an angle their stated position physically sees. Tunnels and lower levels (e.g. Mirage Underpass, Dust2 Lower Tunnels, Overpass Water, Nuke's lower floor) have NO vision of the areas above them — a player assigned there cannot simultaneously hold an upper-level angle. Check every hold assignment against the map's vision facts.
